  ...
  <html>
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a> | Dikembangkan oleh <a href='https://bit.ly/mpkbegarlist' title='MPK SMAN 2 Magelang' target='_blank'>MPK SMAN 2 Magelang</a>
	...
	<?php 
      ...
      $data=mysqli_fetch_assoc($query);
			$query=mysqli_query($koneksi,"SELECT * aspirasi WHERE id_aspirasi='".$_GET['id_aspirasi']."'");
